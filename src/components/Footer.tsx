        ...
        <footer className="bg-[#000000] w-full px-8 py-12 font-onest">
            <div className="flex flex-col lg:flex-row justify-between items-start mb-8 gap-6">
                <div className="flex flex-col gap-2">
                    <Link className="text-white text-xl lg:text-2xl font-medium" href="tel:+79035625952">+7 (903) 562-59-52</Link>
                    <Link className="text-white text-xl lg:text-2xl font-medium" href="tel:+79037643886">+7 (903) 764-38-86</Link>
                ...
                <div className="flex flex-col gap-2 text-center lg:text-right">
                    <Link className="text-white text-xl lg:text-2xl font-medium" href="mailto:mail@basebeauty.ru">mail@basebeauty.ru</Link>
                </div>
            </div>
