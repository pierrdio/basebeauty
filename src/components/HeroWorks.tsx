...
export default function HeroWorks() {
    ...
    // Fallback to static images if no works
    const displayWorks = works.length >= 3 ? works : [
    ...
    return (
        <div className="flex flex-col gap-4 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div 
                    className="relative w-full h-full sm:h-full min-h-[200px] overflow-hidden rounded-2xl sm:rounded-3xl cursor-pointer transition hover:scale-101"
